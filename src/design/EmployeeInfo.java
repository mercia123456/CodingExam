...
import static design.Abstract.addressHeadOffice;

public class EmployeeInfo extends Abstract {
    ...
    public void describeCompany() {
        ...
        System.out.println("In the year 1995 " + owner + " founded the company : " + companyName + " located at " + addressHeadOffice + ".");
    }
