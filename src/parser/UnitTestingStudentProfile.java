...
public class UnitTestingStudentProfile {
    public static void main(String[] args) {
        ...
        Student student = new Student("VICTOR", "MONDAL", "BALLON-D-OR", "222100");

        //Unit test for getFirst name
        try{
            Assert.assertEquals(student.getFirstName(),"VICTOR");
        ...
        try{
            Assert.assertEquals(student.getLastName(),"MONDAL");
